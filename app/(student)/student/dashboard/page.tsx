...
interface UserProfile {
  ...
  learningPath?: string[]; // Kept in interface so existing paths can still generate suggestions if needed
  displayName?: string;
}
...
export default function Dashboard() {
  ...
  // Note: We keep this logic in case learning paths are set by other means (e.g. admin or during onboarding)
  // even though we removed the generator UI from this page.
  useEffect(() => {
  ...
  const renderStudentDashboard = () => {
    ...
    return (
      <div className="space-y-12">
        ...
        {/* --- Suggested Courses (If existing learning path exists) --- */}
